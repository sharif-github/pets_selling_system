...
<body>
	...
	<?php
		...
		$results = mysqli_query( $connect, "SELECT PET_NAME, PET_PRICE FROM pets WHERE PETS_ADDITIONAL_INFO_ID IN
		(SELECT PETS_ADDITIONAL_INFO_ID FROM pets_additional_info WHERE PETS_AVG_LIFE_EXPECTANCY >= 2)" )
